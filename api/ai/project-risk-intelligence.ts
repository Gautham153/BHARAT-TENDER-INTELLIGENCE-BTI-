// Bharat Tender Intelligence (BTI) — Serverless Project Risk Intelligence Handler
// /api/ai/project-risk-intelligence serverless function for Vercel & Cloud deployment
...
function sanitizeErrorMessage(err: unknown): string {
  let message = err instanceof Error ? err.message : typeof err === 'string' ? err : 'Risk intelligence service error occurred.';
